...
train_mix = 'data/Dataset/2speakers/tr/mix'
train_s1 = 'data/Dataset/2speakers/tr/s1'
train_s2 = 'data/Dataset/2speakers/tr/s2'

test_mix = 'data/Dataset/2speakers/tt/mix'
test_s1 = 'data/Dataset/2speakers/tt/s1'
test_s2 = 'data/Dataset/2speakers/tt/s2'
